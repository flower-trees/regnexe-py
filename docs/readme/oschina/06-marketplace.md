# 能力市场换成数据库要改多少代码？regnexe-py 的 Marketplace 设计

> 「regnexe-py 开源实践系列」第 6 篇（共 10 篇），对应仓库 [`examples/readme/06_marketplace.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/06_marketplace.py)。上一篇：[05. 目录加载机制：plugin.yaml 和 SKILL.md 如何变成 Agent 能力](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/05-file-directory-loading.md)。
...
上一篇：[05. 目录加载机制：plugin.yaml 和 SKILL.md 如何变成 Agent 能力](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/05-file-directory-loading.md) ｜ 下一篇：[07. 会话记忆机制设计：regnexe-py 如何用 session_id 接住上下文](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/07-three-layer-memory.md)  
