# Tool、Skill、Sub-Agent 越写越散？用 PluginDescriptor 打成一个插件

> 「Regnexe Python 工程化系列」第 3 篇（共 10 篇），对应仓库 [`examples/readme/03_plugin_packaging.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/03_plugin_packaging.py)。上一篇：[02. Skill 和 Sub-Agent 到底怎么选？Python Agent 子任务别再乱拆了](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/juejin/02-skill-vs-subagent.md)。
...
📌 上一篇：[02. Skill 和 Sub-Agent 到底怎么选？Python Agent 子任务别再乱拆了](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/juejin/02-skill-vs-subagent.md) ｜ 下一篇：[04. 普通 Python 类怎么变成 Agent 插件？@plugin 一次注册四种能力](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/juejin/04-plugin-decorator.md)  
