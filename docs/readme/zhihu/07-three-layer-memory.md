# Agent 的会话记忆，为什么不能只靠一个 history？

> 「Regnexe Python 设计札记」第 7 篇（共 10 篇），对应仓库 [`examples/readme/07_three_layer_memory.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/07_three_layer_memory.py)。上一篇：[06. 能力市场换成数据库，对 Agent 架构意味着什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/06-marketplace.md)。
...
上一篇：[06. 能力市场换成数据库，对 Agent 架构意味着什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/06-marketplace.md) ｜ 下一篇：[08. Agent 系统出问题怎么排查？先聊可观测性设计](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/08-observability.md)  
