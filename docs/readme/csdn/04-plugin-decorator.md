# 一个 Python 类，一次注册，搞定 2 个工具 + 1 个 Skill + 1 个 Sub-Agent

> 「Regnexe Python 实战系列」第 4 篇（共 10 篇），对应仓库 [`examples/readme/04_plugin_decorator.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/04_plugin_decorator.py)。上一篇：[03. Tool、Skill、Sub-Agent 散成一地？PluginDescriptor 一次打成业务插件](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/03-plugin-packaging.md)。

## 痛点：业务代码本来就是类，为什么还要手动拼描述符
...
📌 上一篇：[03. Tool、Skill、Sub-Agent 散成一地？PluginDescriptor 一次打成业务插件](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/03-plugin-packaging.md) ｜ 下一篇：[05. 改个 Skill 文案也要重新发版？with_directory 让插件目录直接生效](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/05-file-directory-loading.md)  
