...
> 「Regnexe Python 设计札记」第 3 篇（共 10 篇），对应仓库 [`examples/readme/03_plugin_packaging.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/03_plugin_packaging.py)。上一篇：[02. Agent 里的 Skill 和 Sub-Agent，本质区别到底是什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/02-skill-vs-subagent.md)。
...
上一篇：[02. Agent 里的 Skill 和 Sub-Agent，本质区别到底是什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/02-skill-vs-subagent.md) ｜ 下一篇：[04. 普通 Python 类，能不能直接变成 Agent 插件？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/04-plugin-decorator.md)  
