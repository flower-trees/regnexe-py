...
> 「Regnexe Python 实战系列」第 5 篇（共 10 篇），对应仓库 [`examples/readme/05_file_directory_loading.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/05_file_directory_loading.py)。上一篇：[04. 一个 Python 类，一次注册，搞定 2 个工具 + 1 个 Skill + 1 个 Sub-Agent](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/04-plugin-decorator.md)。
...
📌 上一篇：[04. 一个 Python 类，一次注册，搞定 2 个工具 + 1 个 Skill + 1 个 Sub-Agent](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/04-plugin-decorator.md) ｜ 下一篇：[06. 能力市场换成数据库要改多少代码？regnexe-py 一个 Marketplace 搞定](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/06-marketplace.md)  
