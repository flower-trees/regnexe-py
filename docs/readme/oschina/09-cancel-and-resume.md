# 任务取消机制设计：regnexe-py 如何真正停止后端 Agent 运行

> 「regnexe-py 开源实践系列」第 9 篇（共 10 篇），对应仓库 [`examples/readme/09_cancel_and_resume.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/09_cancel_and_resume.py)。上一篇：[08. 可观测性设计：regnexe-py 如何暴露 LLM 和工具调用事件](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/08-observability.md)。
...
上一篇：[08. 可观测性设计：regnexe-py 如何暴露 LLM 和工具调用事件](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/08-observability.md) ｜ 系列开篇：[00. 开源一个 Python Agent 应用框架：插件、会话、事件、取消都内置](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/00-intro.md)  
