# Agent 系统出问题怎么排查？先聊可观测性设计

> 「Regnexe Python 设计札记」第 8 篇（共 10 篇），对应仓库 [`examples/readme/08_observability.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/08_observability.py)。上一篇：[07. Agent 的会话记忆，为什么不能只靠一个 history？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/07-three-layer-memory.md)。
...
上一篇：[07. Agent 的会话记忆，为什么不能只靠一个 history？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/07-three-layer-memory.md) ｜ 下一篇：[09. 聊天框里的「停止生成」，到底应该停掉什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/09-cancel-and-resume.md)  
