# Python Agent 接工具，真的一开始就需要插件体系吗？

> 「Regnexe Python 设计札记」第 1 篇（共 10 篇），对应仓库 [`examples/readme/01_multi_tool.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/01_multi_tool.py)。上一篇：[00. 为什么很多 Python Agent Demo，一进业务系统就开始失控？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/00-intro.md)。
...
上一篇：[00. 为什么很多 Python Agent Demo，一进业务系统就开始失控？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/00-intro.md) ｜ 下一篇：[02. Agent 里的 Skill 和 Sub-Agent，本质区别到底是什么？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/02-skill-vs-subagent.md)  
