# 可观测性设计：regnexe-py 如何暴露 LLM 和工具调用事件

> 「regnexe-py 开源实践系列」第 8 篇（共 10 篇），对应仓库 [`examples/readme/08_observability.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/08_observability.py)。上一篇：[07. 会话记忆机制设计：regnexe-py 如何用 session_id 接住上下文](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/07-three-layer-memory.md)。
...
上一篇：[07. 会话记忆机制设计：regnexe-py 如何用 session_id 接住上下文](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/07-three-layer-memory.md) ｜ 下一篇：[09. 任务取消机制设计：regnexe-py 如何真正停止后端 Agent 运行](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/09-cancel-and-resume.md)  
