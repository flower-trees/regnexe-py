# 普通 Python 类，能不能直接变成 Agent 插件？

> 「Regnexe Python 设计札记」第 4 篇（共 10 篇），对应仓库 [`examples/readme/04_plugin_decorator.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/04_plugin_decorator.py)。上一篇：[03. Agent 能力为什么需要被打包成插件？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/03-plugin-packaging.md)。
...
上一篇：[03. Agent 能力为什么需要被打包成插件？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/03-plugin-packaging.md) ｜ 下一篇：[05. Agent 能力一定要写进代码里吗？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/05-file-directory-loading.md)  
