# 目录加载机制：plugin.yaml 和 SKILL.md 如何变成 Agent 能力

> 「regnexe-py 开源实践系列」第 5 篇（共 10 篇），对应仓库 [`examples/readme/05_file_directory_loading.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/05_file_directory_loading.py)。上一篇：[04. @plugin 装饰器设计：一个 Python 类注册多种 Agent 能力](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/04-plugin-decorator.md)。
...
上一篇：[04. @plugin 装饰器设计：一个 Python 类注册多种 Agent 能力](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/04-plugin-decorator.md) ｜ 下一篇：[06. 能力市场换成数据库要改多少代码？regnexe-py 的 Marketplace 设计](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/oschina/06-marketplace.md)  
