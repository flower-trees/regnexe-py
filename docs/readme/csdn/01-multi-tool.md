# 10 行代码跑通 LLM 多工具调用！不用插件、不建类，with_tool 直接上手

> 「Regnexe Python 实战系列」第 1 篇（共 10 篇），对应仓库 [`examples/readme/01_multi_tool.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/01_multi_tool.py)。上一篇：[00. 别再把 Python Agent 写成 Demo 了！我开源了一个能管插件、记忆、事件、取消的框架](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/00-intro.md)。

## 痛点：只是想试个工具，为什么要先设计插件体系

很多 Agent 项目一上来就把工具做成插件、类、配置、注册表。这个方向没错，但对第一个 Demo 来说太重了。
...
📌 上一篇：[00. 别再把 Python Agent 写成 Demo 了！我开源了一个能管插件、记忆、事件、取消的框架](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/00-intro.md) ｜ 下一篇：[02. Skill 和 Sub-Agent 到底差在哪？一个借工具，一个有私有工具](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/csdn/02-skill-vs-subagent.md)  
