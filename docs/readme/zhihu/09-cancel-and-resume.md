...
> 「Regnexe Python 设计札记」第 9 篇（共 10 篇），对应仓库 [`examples/readme/09_cancel_and_resume.py`](https://github.com/flower-trees/regnexe-py/blob/master/examples/readme/09_cancel_and_resume.py)。上一篇：[08. Agent 系统出问题怎么排查？先聊可观测性设计](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/08-observability.md)。
...
上一篇：[08. Agent 系统出问题怎么排查？先聊可观测性设计](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/08-observability.md) ｜ 系列开篇：[00. 为什么很多 Python Agent Demo，一进业务系统就开始失控？](https://github.com/flower-trees/regnexe-py/blob/master/docs/readme/zhihu/00-intro.md)  
